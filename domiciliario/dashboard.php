                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer d-flex justify-content-center">
                                ...
                                <button type="button" class="btn btn-secondary"><a href="edit_perfil.html" class="nav-link">Modificar perfil</a></button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-9 martop">
                <div class="row pro">
                  <div class="col-md-12 d-flex justify-content-around">
                    ...
                    <div class="col-md-3 mediatop white">
                       <a class="nav-link" href="envios.html"> <div class="card">
                            <div class="card-body">
